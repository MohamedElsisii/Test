...
BiocManager::install(c("IlluminaHumanMethylation450kanno.ilmn12.hg19", "minfi", "dpylr", "e1071","impute","preprocessCore"),force = TRUE)
############################################
#1] Import libraries
...
########################################
#4] Loop on downloaded files and then save them as .rda
