...
BiocManager::install(c("TCGAbiolinks", "tidyverse", "maftools", "SummarizedExperiment","sesame", "sesameData"),force = TRUE)
############################################
#1] Import libraries
...
############################################
#3] Set functions to download and label the TCGA data
...
############################################
#4] Define a vector of cancer types to loop over
cancer_types <- c("BLCA","COAD","KIRP","LGG","LIHC","LUAD","MESO","PAAD","READ","SARC","STAD","UCEC","PRAD", "THCA", "SKCM")
############################################
#5] Loop through each cancer type and download its RNA and Methylation data common samples
